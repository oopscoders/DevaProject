                    ...
                    <?php if(isset($wkget_timezone)){ ?>
                            <div class="tab-pane" id="tab-auction">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                  <div class="input-group datetime">
                                          <input type="text" name="auction_start" value="<?php echo $auction_start;?>" placeholder="Start Date" data-date-format="YYYY-MM-DD HH:mm:00" id="input-date-available" class="form-control">
                                          <span class="input-group-btn">
                                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                          </span>
                                  </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                  <div class="input-group datetime">
                                          <input type="text" name="auction_end" value="<?php echo $auction_end;?>" placeholder="End Date" data-date-format="YYYY-MM-DD HH:mm:00" id="input-date-available" class="form-control">
                                          <span class="input-group-btn">
                                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                          </span>
                                  </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                  <div class="input-group datetime">
                                          <input type="text" name="voucher_expiry" value="<?php echo $voucher_expiry;?>" placeholder="Date Available" data-date-format="YYYY-MM-DD HH:mm:ss" id="input-date-available" class="form-control">
                                          <span class="input-group-btn">
                                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                          </span>
                                  </div>                                        
