...
// Zipcode Starts
		public function getProductInfoByZipCode($product_id, $zipcode) {
			$query = $this->db->query("SELECT * FROM ". DB_PREFIX ."product_zipcode WHERE product_id = '". (int)$product_id ."' AND zipcode = '". $this->db->escape($zipcode) ."'");
			
			return $query->row;
		}
		
		// New Code Starts
		public function getTotalProductZipcodes($product_id) {
			$query = $this->db->query("SELECT COUNT(*) as total FROM ". DB_PREFIX ."product_zipcode WHERE product_id = '". (int)$product_id ."'");
