      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-slideshow" class="form-horizontal">
          <div class="form-group">
           ...
           <div class="form-group">
            <label class="col-sm-2 control-label" for="input-name"><?php echo $entry_banner; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="effect" id="input-effect" class="form-control">
                <?php foreach ($effect_seletor as $selector => $name) { ?>
                  <?php if ($effect == $selector) { ?>
                 <option value="<?php echo $selector;?>" selected="selected"><?php echo $name;?></option>
                  <?php } else { ?>
                 <option value="<?php echo $selector;?>" ><?php echo $name;?></option>
                  <?php }?>
                <?php }?>
              </select>
            </div>
...
function addImage() {
  ...
  html += '  <td class="text-right"><input type="text" name="banner_image[' + image_row + '][sort_order]" value="'+ image_row +'" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
