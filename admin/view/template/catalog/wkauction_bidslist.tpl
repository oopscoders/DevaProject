            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group datetime">
                    <input type="text" name="filter_starttime" value="<?php echo $filter_starttime; ?>" placeholder="<?php echo $entry_start_time; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-starttime" class="form-control">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-endtime"><?php echo $entry_end_time ?></label>
                 <div class="input-group datetime">
                    <input type="text" name="filter_endtime" value="<?php echo $filter_endtime; ?>" placeholder="<?php echo $entry_end_time ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-endtime" class="form-control">
                    <span class="input-group-btn">
                    <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>                  </span>
                </div>               
              </div>              
        ...
        <div class="table-responsive">
          ...
          <thead>
            <tr>
              ...
              <td class="text-left"><?php echo ucfirst($entry_winner); ?></td>
